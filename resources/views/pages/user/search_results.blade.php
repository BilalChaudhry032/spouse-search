                    ...
                    <div class="row">
                        ...
                        {{--<div class="profile-detailed-card">
                            <div class="profile-detailed-card-img">
                                <img src="{{URL::asset('/uploads/avatar/')}}/{{ $user->profile_pic}}">
                            </div>
                            <div class="profile-detailed-card-info">
                                <div class="profile-detailed-card-info-container py-3 px-3 ">
                                    <h3 class="font-weight-light border-bottom pb-1 profile-card-name"> {{ $user->name  }} </h3>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 profile-detailed-card-data">
                                            <p>  {{ \Carbon\Carbon::parse($user->dob)->diff(\Carbon\Carbon::now())->format('%y years')}} </p>
                                        </div>
                                        <div class="col-md-6 profile-detailed-card-data">
                                            <p>  {{ $user->martialStat['martial_status'] }} </p>
                                        </div>
                                        <div class="col-sm-6 profile-detailed-card-data">
                                            <p> {{ $user->religionRelation['religion'] }} </p>
                                        </div>
                                        <div class="col-md-6 profile-detailed-card-data">
                                            <p> {{ $user->stateRelation['state'] }}, {{ $user->countryRelation['country'] }} </p>
                                        </div>
                                        <div class="col-md-12">
                                            <p> {{ $user->sectRelation['sect'] }}</p>
                                        </div>
                                    </div>
                                    <div class="row bg-dark text-center profile-contact-list">
                                        ...
                                        <div class="col-md-4">
                                            <form action=""></form>
                                            <a href="{{ url('user/shortlist', $user->id) }}"> <i class="far fa-heart"></i> Add to Favrouite </a>
                                        </div>
                                    </div>
