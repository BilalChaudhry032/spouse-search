...
@section('content')
        ...
        <div class="container">
            <div class="row font-weight-normal">
                ...
                <div class="col-md-8">
                    ...
                    <form method="POST" action="{{ route('invite') }}" id="registration-form" data-parsley-validate>
                        @csrf

                        <input type="hidden" value="{{ $_GET['consultant_id'] }}" name="consultant_id">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!-- City -->
                                    <div class="form-group col-md-6">
                                        <label for="profile-for">{{ __('Select City') }} <span
                                                    class="text-red">*</span></label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                               <div class="row">
                                   ...
                                   <!-- Occupation -->
                                   <div class="form-group col-md-4">
                                       <label for="profile-for">{{ __('Occupation') }} <span
                                                   class="text-red">*</span></label>
                                   ...
                                   <div class="form-group col-md-12">
                                       <label for="about">About
                                           <small>(Tell us about your self.)</small>
                                       </label>
                                       <textarea class="form-control" id="about" name="about" rows="12" placeholder=" You may consider answering these questions:
 ...
 5. Where do you wish to settle down in future?"></textarea>
                        ...
                        <div class="form-navigation">
                            <input type="submit" class="btn btn-red float-right w-100">
...
@section('script')
    <script src="{{ asset('vendor/parsley/parsley.min.js') }}" type="text/javascript"></script>
